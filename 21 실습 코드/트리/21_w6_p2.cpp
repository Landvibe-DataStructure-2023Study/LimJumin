...
//  Week6TreeLandVibe
//
//  Created by 임주민 on 2023/03/30.
//

/*
 특정 노드의 depth 출력하는 프로그램
 */
...
public:
    ...
    Tree() { // 생성자
        root = new Node(nullptr, 1); // 부모 없고 1값을 가지는 root 노드 생성
...
/*
 3. 메인 함수 구현
 첫째 줄에는 트리의 노드 입력 개수 N(1≤N≤100)과 특정 노드의 depth를 묻는 질문 수 M(1≤M≤10000)이 주어짐
