...
/*
 3. 메인 함수 구현
 첫째 줄에는 트리의 노드 입력 개수 N(1≤N≤100)과 특정 노드의 level을 묻는 질문 수 M(1≤M≤10000)이 주어짐
 둘째 줄부터 N개의 줄에 걸쳐 부모 노드와 삽입될 자식 노드가 순서대로 주어진다.
 이후 M개의 줄에 걸쳐 level를 출력할 노드의 data가 주어진다.
 */
int main() {
