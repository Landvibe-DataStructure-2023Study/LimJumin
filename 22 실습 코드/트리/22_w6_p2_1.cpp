...
/*
 특정 노드의 depth 출력하는 프로그램 (21년도 6주차 2번 문제 동일)
 */
...
public:
    ...
    /*
     ...
     2. y가 중복으로 들어오는 경우는 테스트 케이스에 존재하지 않는다.
     */
...
/*
 3. 메인 함수 구현
 첫째 줄에는 트리의 노드 삽입문 개수 N(1≤N≤10000)과 특정 노드의 depth를 묻는 질문 수 M(1≤M≤N)이 주어짐
 둘째 줄부터 N개의 줄에 걸쳐 부모 노드와 삽입될 자식 노드가 순서대로 주어진다.
 이후 M개의 줄에 걸쳐 depth를 출력할 노드의 data가 주어진다.
 트리에 존재하는 노드만 depth를 묻는다.
 */
int main() {
